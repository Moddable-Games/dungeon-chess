...
export let lightAnimState = null

export function stopLightAnim() {
  if (lightAnimState) { lightAnimState.stop = true; lightAnimState = null }
}

export function startLightAnimation(lightsCanvas, map, WALL) {
...
export function renderAtmosphereCanvas(canvas) {
